        ...
        {projects.map((prj,indx)=>(
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-center">
            ...
            <div className="lg:w-1/2">
              <div className="relative h-64 lg:80 bg-slate-100 dark:bg-slate-700 flex items-center justify-center rounded-lg overflow-hidden shadow-lg border border-slate-200 dark:border-slate-600">
                <Image 
                  src={prj.image} 
                  width={600} 
                  height={400} 
